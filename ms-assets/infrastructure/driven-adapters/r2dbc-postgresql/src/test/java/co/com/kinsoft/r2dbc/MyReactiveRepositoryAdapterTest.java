package co.com.kinsoft.r2dbc;

import co.com.kinsoft.r2dbc.dao.asset.AssetDAORepository;
...
class MyReactiveRepositoryAdapterTest {
    ...
    @InjectMocks
    AssetRepositoryAdapter repositoryAdapter;

    @Mock
    AssetDAORepository repository;
